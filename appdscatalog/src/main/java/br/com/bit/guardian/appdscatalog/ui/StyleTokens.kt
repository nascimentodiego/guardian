package br.com.bit.guardian.appdscatalog.ui
...
fun TypographyTokenScreen() {
    ...
    Column(
        ...
        Text(
            text = "typography.titleMedium (Title)",
        ...
        Text(
            text = "typography.titleSmall (Title Small)",
        ...
        Text(
            text = "typography.labelMedium (Subtitle)",
        ...
        Text(
            text = "typography.headlineMedium (Paragraph Bold)",
        ...
        Text(
            text = "typography.bodyMedium (Paragraph)",
        ...
        Text(
            text = "typography.bodySmall (Paragraph Small)",
