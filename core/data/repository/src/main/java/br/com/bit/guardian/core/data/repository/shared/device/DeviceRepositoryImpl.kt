...
import br.com.bit.guardian.core.data.repository.mappers.toDeviceReportItem
...
class DeviceRepositoryImpl @Inject constructor(
    ...
    override fun getReports(): Flow<List<DeviceReportItem>> = flow {
        val response = dataSource.getReports()
            .map(ReportItemResponse::toReportItemModel)
            .map { it.toDeviceReportItem() }
        emit(response)
