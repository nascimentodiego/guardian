...
import br.com.bit.guardian.core.designsystem.R as RD
...
fun BitPlatformHighlight(
    ...
    Column(
        ...
        Image(
            painter = painterResource(id = RD.drawable.ds_ic_bit),
...
val bitHighlightMessages = listOf(
    BitMessage(R.string.login_highlight_title_one, R.string.login_highlight_message_one),
    BitMessage(R.string.login_highlight_title_two, R.string.login_highlight_message_two),
    BitMessage(R.string.login_highlight_title_Three, R.string.login_highlight_message_Three)
)
